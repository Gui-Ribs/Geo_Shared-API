...
namespace GeoShared.Migrations
{
    ...
    [Migration("20230906012416_geosharedUpdate")]
    partial class geosharedUpdate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Main.Models.ContinenteModel", b =>
                {
                    ...
                    b.Property<string>("BiomaModelname")
                        .HasColumnType("varchar(255)");
            ...
            modelBuilder.Entity("Main.Models.ContinenteModel", b =>
                {
                    b.HasOne("Main.Models.BiomaModel", null)
                        .WithMany("Continentes")
                        .HasForeignKey("BiomaModelname");
                });
